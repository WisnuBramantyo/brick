Feature:Register and Login
  ...
  @Positive @Register @TC_001 @TC_002
  ...
  Scenario Outline:Change country code
    ...
    Examples:
      ...
      |   register    |   test first name | test last name  | test19@acc.com | Indonesia | 89123123123   | Singapore    | gotham city | testing | testing        |  register   |
  ...
  Scenario Outline:Login using registered account
    ...
    Examples:
      ...
      |   login       | test19@acc.com  | testing   |  login  |
